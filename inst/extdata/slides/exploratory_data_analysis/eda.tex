...
% NOTE: Too many rows in this table!
% \begin{frame}[allowframebreaks]
%     \frametitle{DETER warnings}
%     \input{./tables/tb_deter_area_by_state_pyear_type.tex}
% \end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_subarea_trajectory_2.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_subarea_trajectory_3.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_subarea_trajectory_4.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_subarea_trajectory_5.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_prodes_subarea_trajectory_2.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_prodes_subarea_trajectory_3.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_prodes_subarea_trajectory_4.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_prodes_subarea_trajectory_5.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_deter_prodes_subarea_trajectory_6.tex}
\end{frame}
...
\begin{frame}[allowframebreaks]
    ...
    \input{./tables/tb_prodes_deter_time_proximity.tex}
\end{frame}
...
% NOTE: The fire spots falling out of DETER aren't necessary degradation.
% \begin{frame}
%     \frametitle{What is the relationship between DETER and Fire Spots?}
%     \begin{itemize}
%         \item Number of fire spots: 4.5 million.
%         \item Fire spots falling inside DETER subareas: 1 million (22\%).
%     \end{itemize}
% \end{frame}
